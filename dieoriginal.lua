...
local NumberOfRolls = 1000000000 -- can divide by 4 because you don't care witch of the 4 1/4 chanses it is they all have the same 1/4 chanse to occur.
...
print("Run time in : ",RunningTime)
print("Highest total roll: ",TotalMax)
print("Number of roll sessions: ",Rolls)
write_log("Stop time: "..os.date()) -- logg data
write_log("Run time in : "..RunningTime)
